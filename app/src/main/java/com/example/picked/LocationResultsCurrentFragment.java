...
public class LocationResultsCurrentFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SharedPreferences locatePref = activity.getSharedPreferences("current_location", activity.MODE_PRIVATE);
        location_search = locatePref.getString(getString(R.string.location_search_current), "none selected");
